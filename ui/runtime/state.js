...
export const state = {
  ...
  hello: null,
  /// What the handshake settled: protocol, contribution API, topology.
  negotiated: null,
  /// Registrations that did not take, with the reason. Shown in diagnostics.
  contributionRefusals: [],
  commands: [],
  scenes: [],
  sessions: [],
  workspaces: [],
 ...
 *   queue, attachments, detail, banner, commands, search
 */
