...
import { $, el, button, icon, clip } from "../dom.js";
import { ICON } from "../icons.js";
import { state, subscribe, emit } from "../state.js";
import { send, interrupt, removeQueued, banner } from "../session.js";
import { call, errorText } from "../rpc.js";
import { scrollToBottom } from "./conversation.js";
...
function openCommandMenu(trigger) {
  const matches = (state.commands || [])
    ...
    .slice(0, 40);
  paintMenu("/", trigger, matches.map((command) => ({
